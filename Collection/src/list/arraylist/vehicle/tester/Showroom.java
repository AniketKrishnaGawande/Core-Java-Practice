package list.arraylist.vehicle.tester;

import static list.arraylist.vehicle.utils.ShowroomUtils.populateShowroom;
import static list.arraylist.vehicle.utils.ValidationRules.findByChasisNo;
import static list.arraylist.vehicle.utils.ValidationRules.parseAndValidateDate;
import static list.arraylist.vehicle.utils.ValidationRules.validateChasisNo;
import static list.arraylist.vehicle.utils.ValidationRules.validateColor;
import static list.arraylist.vehicle.utils.ValidationRules.validatePrice;
			...
			while (!exit) {
				System.out
						.println("Options : 1. Add a vehicle 2. Display 3. Display all vehicles having specified color"
								...
								+ "6. Remove vehilce details 7. Sort vehicle details as per chansis no 10. Exit");
